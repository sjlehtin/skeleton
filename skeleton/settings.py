...
if os.getenv("DISABLE_DEBUG_TOOLBAR"):
...
DATABASES = {
    'default': {
        ...
        'NAME': 'project.db',            # Or path to database file if
                                         # using sqlite3.  The following
                                         # settings are not used with
                                         # sqlite3:
        'USER': '',
        'PASSWORD': '',
        'HOST': '',                      # Empty for localhost through
                                         # domain sockets or '127.0.0.1'
...
SECRET_KEY = '^db^_y9fq2_sc24hqv&1p7wq3m!6+v*%+)h25x2#o4qx%*+m-!'
